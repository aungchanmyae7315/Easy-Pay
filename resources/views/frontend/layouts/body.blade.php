...
<main class="main">
        ...
        <div class="swiper home-swiper">
            <div class="swiper-wrapper">
                ...
                <section class="swiper-slide">
                    <div class="home__content grid">
                        <div class="home__group">
                            <img src="frontend/images/home1-img.png" alt="" class="home__img">
                        ...
                        <div class="home__data">
                            ...
                            <p class="home__description">Hi, I'm AungChanMyae, people call me "Chan Lay". I am currently trying to learn 
                                something new, building my own bike with parts made only in Myanmar.
                            </p>
                ...
                <section class="swiper-slide">
                    <div class="home__content grid">
                        <div class="home__group">
                            <img src="frontend/images/home2-img.png" alt="" class="home__img">
                            <div class="home__indicator"></div>
                ...
                <section class="swiper-slide">
                    <div class="home__content grid">
                        <div class="home__group">
                            <img src="frontend/images/home3-img.png" alt="" class="home__img">
                            <div class="home__indicator"></div>
    ...
    <section class="section about" id="about">
        <div class="about__container container grid">
            ...
            <img src="frontend/images/about-img.png" alt="" class="about__img">
        </div>
    </section>
    ...
    <section class="section trick" id="trick">
        ...
        <div class="trick__container container grid">
            <div class="trick__content">
                <img src="frontend/images/trick-treat1-img.png" alt="" class="trick__img">
            ...
            <div class="trick__content">
                <img src="frontend/images/trick-treat2-img.png" alt="" class="trick__img">
            ...
            <div class="trick__content">
                <img src="frontend/images/trick-treat3-img.png" alt="" class="trick__img">
            ...
            <div class="trick__content">
                <img src="frontend/images/trick-treat4-img.png" alt="" class="trick__img">
            ...
            <div class="trick__content">
                <img src="frontend/images/trick-treat5-img.png" alt="" class="trick__img">
            ...
            <div class="trick__content">
                <img src="frontend/images/trick-treat6-img.png" alt="" class="trick__img">
    ...
    <section class="section discount">
        <div class="discount__container container grid">
            ...
            <img src="frontend/images/discount-img.png" alt="" class="discount__img">
        </div>
    </section>
            ...
            <div class="swiper new-swiper">
                <div class="swiper-wrapper">
                    <div class="new__content swiper-slide">
                        ...
                        <img src="frontend/images/new1-img.png" alt="" class="new__img">
                    ...
                    <div class="new__content swiper-slide">
                        <div class="new__tag">New</div>
                        <img src="frontend/images/new2-img.png" alt="" class="new__img">
                    ...
                    <div class="new__content swiper-slide">
                        <div class="new__tag">New</div>
                        <img src="frontend/images/new3-img.png" alt="" class="new__img">
                    ...
                    <div class="new__content swiper-slide">
                        <div class="new__tag">New</div>
                        <img src="frontend/images/new4-img.png" alt="" class="new__img">
                    ...
                    <div class="new__content swiper-slide">
                        <div class="new__tag">New</div>
                        <img src="frontend/images/new5-img.png" alt="" class="new__img">
                    ...
                    <div class="new__content swiper-slide">
                        <div class="new__tag">New</div>
                        <img src="frontend/images/new6-img.png" alt="" class="new__img">
